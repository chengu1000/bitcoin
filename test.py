...
access = "vcJTH06hDw0Hww6p3ovEszogEkNIDdpCO17V7hA4"
secret = "Rt5mSxXxGYO0JxNgERPPbFZLMOhppxrNxyoI3C5E"
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price_btc < current_price_btc and ma15_btc < current_price_btc:
                krw = get_balance("KRW")
                count = count + 1
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-BTC", krw*0.9995/(5-count))
            ...
            if target_price_eth < current_price_eth and ma15_eth < current_price_eth:
                krw = get_balance("KRW")
                count = count + 1
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-ETH", krw*0.9995/(5-count))
            ...
            if target_price_doge < current_price_doge and ma15_doge < current_price_doge:
                krw = get_balance("KRW")
                count = count + 1
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-DOGE", krw*0.9995/(5-count))
            ...
            if target_price_XRP < current_price_XRP and ma15_XRP < current_price_XRP:
                ...
                count = count + 1
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-XRP", krw*0.9995/(5-count))
            ...
            if target_price_ADA < current_price_ADA and ma15_ADA < current_price_ADA:
                ...
                count = count + 1
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-ADA", krw*0.9995/(5-count))
